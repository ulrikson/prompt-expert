...
function addPrecognition() {
  return `
    <thinking>
    Take a deep breath and work on this problem step by step. Begin in <scratchpad> tags and write out and brainstorm a couple of paragraphs (not bullet points) on your plan for how you'll adhere to role, goal and instructions provided.
    </thinking>
  `;
}
